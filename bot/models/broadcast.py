...
class Broadcast(Base, TimestampMixin):
    ...
    filter_type: Mapped[str] = mapped_column(String(50), default="all", nullable=False)  # all/active/inactive/tariff_X
    filter_language: Mapped[str] = mapped_column(String(10), default="all", nullable=False)  # all/ru/en
    total_users: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    sent_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    failed_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    status: Mapped[str] = mapped_column(String(20), default="draft", nullable=False)  # draft/running/paused/completed/cancelled
